...
namespace Braintrust
{
    public partial class DatasetSnapshotsClient
    {
        ...
        partial void PrepareGetDatasetSnapshotArguments(
            ...
            ref string? datasetSnapshotName,
            ref string? orgName);
        partial void PrepareGetDatasetSnapshotRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? datasetSnapshotName,
            string? orgName);
        partial void ProcessGetDatasetSnapshotResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetDatasetSnapshotResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List dataset_snapshots<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Braintrust.GetDatasetSnapshotResponse> GetDatasetSnapshotAsync(
            int? limit = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Braintrust.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Braintrust.AutoSDKHttpResponse<global::Braintrust.GetDatasetSnapshotResponse>> GetDatasetSnapshotAsResponseAsync(
            int? limit = default,
            global::System.Guid? startingAfter = default,
            global::System.Guid? endingBefore = default,
            global::Braintrust.Ids? ids = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetDatasetSnapshotArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetDatasetSnapshotRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Braintrust.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Braintrust.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetDatasetSnapshotAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetDatasetSnapshotResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Braintrust.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetDatasetSnapshotResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Braintrust.AutoSDKHttpResponse<global::Braintrust.GetDatasetSnapshotResponse>(
                                        statusCode: __response.StatusCode,
