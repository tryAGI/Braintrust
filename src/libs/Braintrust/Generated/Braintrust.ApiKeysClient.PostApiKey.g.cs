            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Braintrust.CreateApiKeyOutput.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Braintrust.CreateApiKeyOutput.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
