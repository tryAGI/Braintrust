            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Braintrust.Dataset.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Braintrust.Dataset.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
