...
namespace Braintrust
{
    public partial class DatasetSnapshotsClient
    {
        ...
        private static readonly global::Braintrust.EndPointSecurityRequirement s_PostDatasetSnapshotSecurityRequirement0 =
        ...
        private static readonly global::Braintrust.EndPointSecurityRequirement s_PostDatasetSnapshotSecurityRequirement1 =
            new global::Braintrust.EndPointSecurityRequirement
            {
                Authorizations = new global::Braintrust.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::Braintrust.EndPointSecurityRequirement[] s_PostDatasetSnapshotSecurityRequirements =
            new global::Braintrust.EndPointSecurityRequirement[]
            {                s_PostDatasetSnapshotSecurityRequirement0,
                s_PostDatasetSnapshotSecurityRequirement1,
            };
        partial void PreparePostDatasetSnapshotArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Braintrust.CreateDatasetSnapshot request);
        partial void PreparePostDatasetSnapshotRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Braintrust.CreateDatasetSnapshot request);
        partial void ProcessPostDatasetSnapshotResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostDatasetSnapshotResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Braintrust.DatasetSnapshot> PostDatasetSnapshotAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Braintrust.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Braintrust.AutoSDKHttpResponse<global::Braintrust.DatasetSnapshot>> PostDatasetSnapshotAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostDatasetSnapshotArguments(
            ...
            var __authorizations = global::Braintrust.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostDatasetSnapshotSecurityRequirements,
                operationName: "PostDatasetSnapshotAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostDatasetSnapshotRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Braintrust.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Braintrust.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostDatasetSnapshot",
                                methodName: "PostDatasetSnapshotAsync",
                                pathTemplate: "\"/v1/dataset_snapshot\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostDatasetSnapshotResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Braintrust.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostDatasetSnapshotResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Braintrust.DatasetSnapshot> PostDatasetSnapshotAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Braintrust.CreateDatasetSnapshot
            {
                DatasetId = datasetId,
                Name = name,
            ...
            return await PostDatasetSnapshotAsync(
                request: __request,
                requestOptions: requestOptions,
